;(() => {
  ...
  var t,
    ...
    r = {
      913: (t, e, r) => {
        ...
        var c = !1
        function s(t) {
          c && console.log(JSON.stringify(t))
        }
        function u(t) {
          t.preventDefault && t.preventDefault()
        }
        function l(t, e, r, n) {
          if (t.data && t.data.shuffle) {
            var a = document.getElementById(r)
            ;(0 != a.width && 0 != a.height) || setTimeout(l(t, e, r, n), 50)
            var i = document.getElementById(e),
              o = i.getContext('2d')
            ;(a = document.getElementById(r)), (i.width = a.width), (i.height = a.height)
            for (
              var c = t.data.shuffle,
                s = t.backgroundImageWidth,
                u = t.backgroundImageHeight,
                d = i.width,
                p = i.height,
                h = c.x,
                f = c.y,
              ...
              for (var k = 0; k < h; k++)
                b.push({ startX: Math.floor(k * g), startY: Math.floor(C * A) }),
                  w.push({ startX: Math.round(k * m), startY: Math.round(C * y) })
            for (
              var D = [],
                E = function() {
                  var t = v[B],
                    ...
                    r = w[B]
                  D.push(function() {
                    o.drawImage(a, e.startX, e.startY, g, A, r.startX, r.startY, m, y)
                  })
                },
                B = 0;
              B < v.length;
        ...
        function p(t) {
          var e = d(t),
            r = e.x,
            n = e.y
          ;(currentCaptcha.currentCaptchaData.startX = r), (currentCaptcha.currentCaptchaData.startY = n)
          var a = currentCaptcha.currentCaptchaData.startX,
            i = currentCaptcha.currentCaptchaData.startY,
            o = currentCaptcha.currentCaptchaData.startTime
          currentCaptcha.currentCaptchaData.trackArr.push({ x: a - r, y: i - n, type: 'down', t: new Date().getTime() - o.getTime() }),
            s(['start', r, n]),
            window.addEventListener('mousemove', h),
            window.addEventListener('mouseup', v),
            window.addEventListener('touchmove', h, !1),
            window.addEventListener('touchend', v, !1),
        ...
        function h(t) {
          ...
          var e = d(t),
            r = e.x,
            n = e.y,
            a = window.currentCaptcha.currentCaptchaData.startX,
            i = window.currentCaptcha.currentCaptchaData.startY,
            o = window.currentCaptcha.currentCaptchaData.startTime,
            c = window.currentCaptcha.currentCaptchaData.end,
            u = window.currentCaptcha.currentCaptchaData.bgImageWidth,
            l = window.currentCaptcha.currentCaptchaData.trackArr,
            p = r - a,
            h = { x: r - a, y: n - i, type: 'move', t: new Date().getTime() - o.getTime() }
          l.push(h),
            p < 0 ? (p = 0) : p > c && (p = c),
            (window.currentCaptcha.currentCaptchaData.moveX = p),
            (window.currentCaptcha.currentCaptchaData.movePercent = p / u),
        ...
        function v(t) {
          ...
          var r = e.x,
            n = e.y,
            a = currentCaptcha.currentCaptchaData.startX,
            i = currentCaptcha.currentCaptchaData.startY,
            o = currentCaptcha.currentCaptchaData.startTime,
            c = currentCaptcha.currentCaptchaData.trackArr,
            u = { x: r - a, y: n - i, type: 'up', t: new Date().getTime() - o.getTime() }
          c.push(u),
            s(['up', u]),
        ...
        function g(t, e, r, n, a) {
          var i = {
            ...
            sliderImageWidth: Math.round(r),
            sliderImageHeight: Math.round(n),
            end: a,
          }
          return s(['init', i]), i
        }
        ...
        function m(t, e, r, n) {
          var i = a()(t.find('#tianai-captcha-tips'))
          i.text(e),
            1 === r
              ? (i.removeClass('tianai-captcha-tips-error'), i.addClass('tianai-captcha-tips-success'))
              : (i.removeClass('tianai-captcha-tips-success'), i.addClass('tianai-captcha-tips-error')),
            i.addClass('tianai-captcha-tips-on'),
            setTimeout(n, 1e3)
        }
        var y = (function() {
          function t() {
        ...
        const D = (function(t) {
          ...
          function c(t, e) {
            ...
            return (
              ...
              ((r = o.call(this)).boxEl = a()(t)),
              (r.styleConfig = e),
              (r.type = 'SLIDER'),
              (r.currentCaptchaData = {}),
              r
            )
          }
          return (
            ...
            (r = [
              {
                ...
                value: function(t, e, r) {
                  return (
                    ...
                    (this.el = a()(this.boxEl.find('#tianai-captcha'))),
                    this.loadStyle(),
                    this.el.find('#tianai-captcha-slider-move-btn').mousedown(p),
                    this.el.find('#tianai-captcha-slider-move-btn').on('touchstart', p),
              ...
              },
              {
                key: 'destroy',
                value: function() {
                  var t = this.boxEl.children('#tianai-captcha')
                  t && t.remove(), f()
                },
              },
              {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  i &&
                    ((t = i.btnUrl),
                    (e = i.bgUrl),
                    (n = i.moveTrackMaskBgColor),
                    (r = i.moveTrackMaskBorderColor),
                    i.logoUrl && (a = this.styleConfig.logoUrl)),
                    this.el.find('#tianai-captcha-logo').attr('src', a),
                    this.el.find('#tianai-captcha-bg-img').css('background-image', 'url(' + e + ')'),
                    this.el.find('.slider-move .slider-move-btn').css('background-image', 'url(' + t + ')'),
                    this.el.find('#tianai-captcha-slider-move-track-mask').css('border-color', r),
                    this.el.find('#tianai-captcha-slider-move-track-mask').css('background-color', n)
                },
              },
              {
                key: 'loadCaptchaForData',
                value: function(t, e) {
                  var r = t.el.find('#tianai-captcha-slider-bg-img'),
                    n = t.el.find('#tianai-captcha-slider-move-img')
                  r.attr('src', e.captcha.backgroundImage),
                    n.attr('src', e.captcha.templateImage),
                    r.on('load', function() {
                      ;(t.currentCaptchaData = g(r.width(), r.height(), n.width(), n.height(), 242)),
                        (t.currentCaptchaData.currentCaptchaId = e.id),
                        l(e.captcha, 'tianai-captcha-slider-bg-canvas', 'tianai-captcha-slider-bg-img', 50)
                    })
                },
              },
            ]) && w(e.prototype, r),
          ...
          return (
            ...
            (r = [
                ...
                value: function(t, e, r) {
                  return (
                    ...
                    this.el.each(function(t, e) {
                      e.addEventListener('touchmove', u, { passive: !1 }), e.addEventListener('mousemove', u, { passive: !1 })
                    }),
                    (window.currentCaptcha = this),
                    this.loadCaptchaForData(this, t),
                    (this.endCallback = e),
              ...
              },
              {
                key: 'loadCaptchaForData',
                value: function(t, e) {
                  var r = t.el.find('.tianai-captcha-slider-concat-bg-img'),
                    n = t.el.find('#tianai-captcha-slider-concat-img-div')
                  r.css('background-image', 'url(' + e.captcha.backgroundImage + ')'),
                    n.css('background-image', 'url(' + e.captcha.backgroundImage + ')'),
                    n.css('background-position', '0px 0px')
                  var a = e.captcha.backgroundImageHeight,
                    i = ((a - e.captcha.data.randomY) / a) * 180
                  n.css('height', i),
                    (t.currentCaptchaData = g(r.width(), r.height(), n.width(), n.height(), 242)),
                    (t.currentCaptchaData.currentCaptchaId = e.id)
                },
        ...
        const K = (function(t) {
          ...
          function i(t, e) {
            ...
            return (
              ...
              ((r = a.call(this, t, e)).type = 'WORD_IMAGE_CLICK'),
              r
            )
          }
              ...
              (r = [
                {
                  ...
                  value: function(t, e, r) {
                    ...
                    return (
                      ...
                      this.loadCaptchaForData(this, t),
                      (this.endCallback = e),
                      this.el.find('#bg-img-click-mask').click(function(t) {
                        n.currentCaptchaData.clickCount++
                        var e = n.currentCaptchaData.trackArr,
                          r = n.currentCaptchaData.startTime
                        1 === n.currentCaptchaData.clickCount &&
                          (window.addEventListener('mousemove', h),
                          (n.currentCaptchaData.startX = t.offsetX),
                          (n.currentCaptchaData.startY = t.offsetY)),
                          e.push({
                            x: Math.round(t.offsetX),
                            y: Math.round(t.offsetY),
                            type: 'click',
                            t: new Date().getTime() - r.getTime(),
                          })
                        var a = t.offsetX - 10,
                          i = t.offsetY - 10
                        n.el
                          ...
                          4 === n.currentCaptchaData.clickCount &&
                            ((n.currentCaptchaData.stopTime = new Date()),
                            window.removeEventListener('mousemove', h),
                            n.endCallback(n.currentCaptchaData, n))
                      }),
                      r && r(this),
                      this
                    )
                ...
                },
                {
                  ...
                  value: function(t, e) {
                    var r = t.el.find('#tianai-captcha-slider-bg-img'),
                      n = t.el.find('#tianai-captcha-tip-img')
                    r.on('load', function() {
                      ;(t.currentCaptchaData = g(r.width(), r.height(), n.width(), n.height())),
                        (t.currentCaptchaData.currentCaptchaId = e.id),
                        l(e.captcha, 'tianai-captcha-slider-bg-canvas', 'tianai-captcha-slider-bg-img', 50)
                    }),
                      r.attr('src', e.captcha.backgroundImage),
        ...
        var z = (function() {
            function t(e) {
              ...
              if (!e.requestCaptchaDataUrl) throw new Error('[TAC] 必须配置 [requestCaptchaDataUrl]请求验证码接口')
              if (!e.validCaptchaUrl) throw new Error('[TAC] 必须配置 [validCaptchaUrl]验证验证码接口')
              ;(this.bindEl = e.bindEl),
                (this.$bindEl = a()(e.bindEl)),
                (this.requestCaptchaDataUrl = e.requestCaptchaDataUrl),
                (this.validCaptchaUrl = e.validCaptchaUrl),
                e.validSuccess && (this.validSuccess = e.validSuccess),
                e.validFail && (this.validFail = e.validFail),
                (this.requestChain = []),
                this.addRequestChainByString(e.chainString)
            }
            var e, r
            return (
              (e = t),
              (r = [
                    ...
                    if (t) {
                      ...
                      try {
                        for (r.s(); !(e = r.n()).done; ) {
                          var n = e.value,
                            a = J[n]
                          if (!a) throw new Error('[TAC] chains错误， 无法读取到['.concat(n, ']'))
                          this.addRequestChain(a)
                        }
                      } catch (t) {
                        r.e(t)
                      } finally {
                ...
                },
                {
                  ...
                  value: function() {
                    var t = this,
                      e = {}
                    return (
                      this._preRequest('requestCaptchaData', e),
                      this.doSendRequest('requestCaptchaData', e).then(function(r) {
                        return t._postRequest('requestCaptchaData', e, r), r
                      })
                    )
                  },
                },
                {
                  ...
                  value: function(t, e) {
                    var r
                    return (
                      (r = 'requestCaptchaData' === t ? this.requestCaptchaDataUrl : this.validCaptchaUrl),
                ...
                },
                {
                  ...
                  value: function(t, e, r, n) {
                    for (var a = 0; a < this.requestChain.length; a++) {
                      var i = this.requestChain[a]
                      if (i.preRequest && !i.preRequest(t, e, this, r, n)) break
                    }
                  },
                },
                {
                  ...
                  value: function(t, e, r, n, a) {
                    for (var i = 0; i < this.requestChain.length; i++) {
                      var o = this.requestChain[i]
                      if (o.postRequest && !o.postRequest(t, e, r, this, n, a)) break
                    }
                  },
                },
                {
                  ...
                  value: function(t, e, r, n) {
                    var a = this,
                      i = { id: t, data: e }
                    return (
                      this._preRequest('validCaptcha', i, r, n),
                      this.doSendRequest('validCaptcha', i)
                        .then(function(t) {
                          return a._postRequest('validCaptcha', i, t, r, n), t
                        })
                        .then(function(t) {
                          if (200 === t.code) {
                            var i = (e.endSlidingTime - e.startSlidingTime) / 1e3
                            r.showTips('验证成功,耗时'.concat(i, '秒'), 1, function() {
                              return a.validSuccess(t, r, n)
                            })
                          } else {
                            var o = '验证失败，请重新尝试!'
                            t.code && 4001 !== t.code && (o = '验证码被黑洞吸走了！'),
                              r.showTips(o, 0, function() {
                                return a.validFail(t, r, n)
                              })
                          }
                        })
                    )
          ...
          function t(e, r) {
            !(function(t, e) {
              ...
              (this.config = (function(t) {
                return t instanceof z ? t : new z(t)
              })(e)),
            ...
            (r = [
              {
                ...
                value: function() {
                  ...
                  return (
                    ...
                    this.loadStyle(),
                    this.config.$bindEl.find('#tianai-captcha-slider-refresh-btn').click(function() {
                      t.reloadCaptcha()
                    }),
                    this.config.$bindEl.find('#tianai-captcha-slider-close-btn').click(function() {
                      t.destroyWindow()
                    }),
                    this.reloadCaptcha(),
                    this
              ...
              },
              {
                ...
                value: function() {
                  ...
                  t && this.config.$bindEl.find('#tianai-captcha-bg-img').css('background-image', 'url(' + t + ')'),
                    e &&
                      ('' !== e
                        ? this.config.$bindEl.find('#tianai-captcha-logo').attr('src', e)
              ...
              },
              {
                key: 'destroyWindow',
                value: function() {
                  ;(window.currentCaptcha = void 0), this.config.$bindEl.find('#tianai-captcha-parent').remove()
                },
              },
              {
                key: 'openCaptcha',
              ...
              },
              {
                ...
                value: function() {
                  var t = this
                  this.config.requestCaptchaData().then(function(e) {
                    t.closeLoading()
                    var r = (function(t, e) {
                      switch (t) {
                        case 'SLIDER':
                          return new D('#tianai-captcha-box', e)
                        case 'ROTATE':
                          return new j('#tianai-captcha-box', e)
                        case 'CONCAT':
                          return new G('#tianai-captcha-box', e)
                        case 'WORD_IMAGE_CLICK':
                          return new K('#tianai-captcha-box', e)
                        default:
                          return null
                      }
                    })(e.captcha.type, t.style)
                    if (null == r) throw new Error('[TAC] 未知的验证码类型[' + e.captcha.type + ']')
                    r.init(e, function(e, r) {
                      var n = r.currentCaptchaData,
                        a = {
                          bgImageWidth: n.bgImageWidth,
                          bgImageHeight: n.bgImageHeight,
                          sliderImageWidth: n.sliderImageWidth,
                          sliderImageHeight: n.sliderImageHeight,
                          startSlidingTime: n.startTime,
                          endSlidingTime: n.stopTime,
                          trackList: n.trackArr,
                        }
                      ;('ROTATE_DEGREE' !== r.type && 'ROTATE' !== r.type) || (a.bgImageWidth = r.currentCaptchaData.end)
                      var i = r.currentCaptchaData.currentCaptchaId
                      ;(r.currentCaptchaData = void 0), t.config.validCaptcha(i, a, r, t)
                    }),
                      t.openCaptcha()
                  })
                },
        ...
        ;(window.TAC = X), (window.CaptchaConfig = z)
      },
      783: (t, e, r) => {
        var n = r(618),
        ...
        t.exports = function(t, e) {
          if (i) return console.log('no window.document found, will not HMR CSS'), c
          var r,
            d,
            p = (function(t) {
              var e = a[t]
              ...
              return function(t) {
                ...
                return a && t
                  ? t.split(',').map(function(t) {
                      var r = new RegExp(''.concat(a, '\\.js$'), 'g')
                      return n(e.replace(r, ''.concat(t.replace(/{fileName}/g, a), '.css')))
                    })
                  : [e.replace('.js', '.css')]
              }
            })(t)
                  ...
                  return (
                    o.call(e, function(e) {
                      if (e.href) {
                        ...
                        l(a) && !0 !== e.visited && a && (s(e, a), (r = !0))
                      }
                    }),
                    r
                  )
                })(t)
              if (e.locals) return console.log('[HMR] Detected local css modules. Reload all css'), void u()
              r ? console.log('[HMR] css reload %s', t.join(' ')) : (console.log('[HMR] Reload all css'), u())
            }),
            50,
            (d = 0),
            function() {
  ...
  function a(t) {
    ...
    try {
      var o = { id: t, module: i, factory: r[t], require: a }
      a.i.forEach(function(t) {
        t(o)
      }),
        (i = o.module),
        o.factory.call(i.exports, i, i.exports, o.require)
    } catch (t) {
      throw ((i.error = t), t)
    }
    return i.exports
  ...
  ;(a.m = r),
    ...
    (a.hu = t => t + '.' + a.h() + '.hot-update.js'),
    (a.miniCssF = t => {}),
    (a.hmrF = () => 'main.' + a.h() + '.hot-update.json'),
    (a.h = () => '5f2fe5cc4c7dcbe0724d'),
    (a.g = (function() {
    ...
    (a.l = (r, n, i, o) => {
      if (t[r]) t[r].push(n)
        ...
        var p = (e, n) => {
            ...
            var a = t[r]
            if ((delete t[r], c.parentNode && c.parentNode.removeChild(c), a && a.forEach(t => t(n)), e)) return e(n)
          },
    ...
    (() => {
            ...
            return r
              ? d('prepare').then(function() {
                  ...
                  return (
                    (e = []),
                    Promise.all(
                      Object.keys(a.hmrC).reduce(function(t, i) {
                        return a.hmrC[i](r.c, r.r, r.m, t, e, n), t
                      }, [])
                    ).then(function() {
                      return (
                        (e = function() {
      ...
      function v(t) {
        ...
        return (
          n.forEach(function(t) {
            if (t.apply) {
              var e = t.apply(s)
              if (e) for (var r = 0; r < e.length; r++) u.push(e[r])
            }
          }),
      ...
      function g() {
        if (r)
          return (
            e || (e = []),
            Object.keys(a.hmrI).forEach(function(t) {
            ...
            b = (function(e, r) {
              ...
              var a = function(a) {
                  if (n.hot.active) {
                    ...
                    ;-1 === n.children.indexOf(a) && n.children.push(a)
                  } else console.warn('[HMR] unexpected require(' + a + ') from disposed module ' + r), (o = [])
                  return e(a)
                },
                c = function(t) {
                  return {
              ...
              for (var l in e) Object.prototype.hasOwnProperty.call(e, l) && 'e' !== l && Object.defineProperty(a, l, c(l))
              return (
                (a.e = function(t) {
                  return (function(t) {
                    switch (s) {
          ...
          ;(y.hot =
            ...
            (m = {
              ...
              _requireSelf: function() {
                ;(o = g.parents.slice()), (t = A ? void 0 : v), a(v)
              },
              active: !0,
              accept: function(t, e, r) {
                if (void 0 === t) m._selfAccepted = !0
                  ...
                  for (var n = 0; n < t.length; n++)
                    (m._acceptedDependencies[t[n]] = e || function() {}), (m._acceptedErrorHandlers[t[n]] = r)
                else (m._acceptedDependencies[t] = e || function() {}), (m._acceptedErrorHandlers[t] = r)
              },
              decline: function(t) {
                if (void 0 === t) m._selfDeclined = !0
                else if ('object' == typeof t && null !== t) for (var e = 0; e < t.length; e++) m._declinedDependencies[t[e]] = !0
      ...
      if ('undefined' != typeof document) {
        var t = [],
          ...
          r = r => ({
            ...
            apply: () => {
              for (var t = 0; t < e.length; t++) e[t].rel = 'stylesheet'
              e.length = 0
            },
          })
        a.hmrC.miniCss = (n, i, o, c, s, u) => {
          s.push(r),
            n.forEach(r => {
              var n = a.miniCssF(r),
                i = a.p + n,
    ...
    (() => {
      var t,
        ...
        n,
        i,
        o = (a.hmrS_jsonp = a.hmrS_jsonp || { 179: 0 }),
        c = {}
      function s(e, r) {
        return (
          (t = r),
        ...
        function c(t) {
          for (
            ...
            if (u && (!u.hot._selfAccepted || u.hot._selfInvalidated)) {
              if (u.hot._selfDeclined) return { type: 'self-declined', chain: c, moduleId: o }
              if (u.hot._main) return { type: 'unaccepted', chain: c, moduleId: o }
              for (var l = 0; l < u.parents.length; l++) {
                var d = u.parents[l],
                  p = a.c[d]
                if (p) {
                  if (p.hot._declinedDependencies[o]) return { type: 'declined', chain: c.concat([d]), moduleId: o, parentId: d }
                  ;-1 === e.indexOf(d) &&
                    (p.hot._acceptedDependencies[o]
                      ? (r[d] || (r[d] = []), s(r[d], [o]))
                      : (delete r[d], e.push(d), n.push({ chain: c.concat([d]), id: d })))
                }
              }
            }
          }
        ...
        for (var h in r)
          if (a.o(r, h)) {
            var f,
              ...
              y = ''
            switch (
              ((f = v ? c(h) : { type: 'disposed', moduleId: h }).chain && (y = '\nUpdate propagation: ' + f.chain.join(' -> ')), f.type)
            ) {
              case 'self-declined':
                t.onDeclined && t.onDeclined(f), t.ignoreDeclined || (g = new Error('Aborted because of self decline: ' + f.moduleId + y))
                break
              case 'declined':
                t.onDeclined && t.onDeclined(f),
                  t.ignoreDeclined || (g = new Error('Aborted because of declined dependency: ' + f.moduleId + ' in ' + f.parentId + y))
                break
              case 'unaccepted':
                t.onUnaccepted && t.onUnaccepted(f), t.ignoreUnaccepted || (g = new Error('Aborted because ' + h + ' is not accepted' + y))
                break
              case 'accepted':
                t.onAccepted && t.onAccepted(f), (A = !0)
                break
              case 'disposed':
                t.onDisposed && t.onDisposed(f), (m = !0)
                break
              default:
            ...
            if (g) return { error: g }
            if (A)
              for (h in ((d[h] = v), s(l, f.outdatedModules), f.outdatedDependencies))
                a.o(f.outdatedDependencies, h) && (u[h] || (u[h] = []), s(u[h], f.outdatedDependencies[h]))
            m && (s(l, [f.moduleId]), (d[h] = p))
          }
        r = void 0
        for (var b, w = [], C = 0; C < l.length; C++) {
          var k = l[C],
            D = a.c[k]
          D &&
            ...
            w.push({ module: k, require: D.hot._requireSelf, errorHandler: D.hot._selfAccepted })
        }
        return {
          dispose: function() {
            var t
            n.forEach(function(t) {
              ...
              (n = void 0)
            for (var e, r = l.slice(); r.length > 0; ) {
              var i = r.pop(),
                c = a.c[i]
              if (c) {
                var s = {},
                  d = c.hot._disposeHandlers
                for (C = 0; C < d.length; C++) d[C].call(null, s)
                for (a.hmrD[i] = s, c.hot.active = !1, delete a.c[i], delete u[i], C = 0; C < c.children.length; C++) {
                  var p = a.c[c.children[C]]
            ...
            for (var h in u)
              if (a.o(u, h) && (c = a.c[h]))
                for (b = u[h], C = 0; C < b.length; C++) (e = b[C]), (t = c.children.indexOf(e)) >= 0 && c.children.splice(t, 1)
          },
          apply: function(e) {
            for (var r in d) a.o(d, r) && (a.m[r] = d[r])
            for (var n = 0; n < i.length; n++) i[n](a)
            for (var o in u)
              if (a.o(u, o)) {
                var c = a.c[o]
                if (c) {
                  b = u[o]
                  for (var s = [], p = [], h = [], f = 0; f < b.length; f++) {
                    var v = b[f],
                      g = c.hot._acceptedDependencies[v],
                      A = c.hot._acceptedErrorHandlers[v]
                    if (g) {
                      if (-1 !== s.indexOf(g)) continue
                      s.push(g), p.push(A), h.push(v)
                    }
                  }
                  for (var m = 0; m < s.length; m++)
                    try {
                      ...
                      if ('function' == typeof p[m])
                        try {
                          p[m](r, { moduleId: o, dependencyId: h[m] })
                        } catch (n) {
                          t.onErrored &&
                            t.onErrored({
                        ...
                        t.onErrored && t.onErrored({ type: 'accept-errored', moduleId: o, dependencyId: h[m], error: r }),
                          t.ignoreErrored || e(r)
                    }
                }
              }
            for (var y = 0; y < w.length; y++) {
              ...
              try {
                ...
                if ('function' == typeof C.errorHandler)
                  try {
                    C.errorHandler(r, { moduleId: k, module: a.c[k] })
                  } catch (n) {
                    t.onErrored && t.onErrored({ type: 'self-accept-error-handler-errored', moduleId: k, error: n, originalError: r }),
                      t.ignoreErrored || (e(n), e(r))
                  }
                else t.onErrored && t.onErrored({ type: 'self-accept-errored', moduleId: k, error: r }), t.ignoreErrored || e(r)
              }
            }
            return l
          },
      ...
      ;(self.webpackHotUpdatewebpack_demo = (e, n, o) => {
        for (var s in n) a.o(n, s) && ((r[s] = n[s]), t && t.push(s))
        o && i.push(o), c[e] && (c[e](), (c[e] = void 0))
      }),
        (a.hmrI.jsonp = function(t, e) {
          r || ((r = {}), (i = []), (n = []), e.push(u)), a.o(r, t) || (r[t] = a.m[t])
        }),
        (a.hmrC.jsonp = function(t, c, l, d, p, h) {
          p.push(u),
            (e = {}),
            (n = c),
            ...
            t.forEach(function(t) {
              a.o(o, t) && void 0 !== o[t] ? (d.push(s(t, h)), (e[t] = !0)) : (e[t] = !1)
            }),
            a.f &&
              (a.f.jsonpHmr = function(t, r) {
                e && a.o(e, t) && !e[t] && (r.push(s(t)), (e[t] = !0))
              })
        }),
        (a.hmrM = () => {
          if ('undefined' == typeof fetch) throw new Error('No browser support: need fetch API')
          return fetch(a.p + a.hmrF()).then(t => {
            if (404 !== t.status) {
